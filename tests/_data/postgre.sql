...
CREATE TABLE "test_delete" ("id" SERIAL, "name" VARCHAR (256), "value" BOOL);
INSERT INTO "test_delete" ("name", "value") VALUES ('name 1', true), ('name 2', false);
CREATE TABLE "test_update" ("id" SERIAL, "name" VARCHAR (256), "value" INTEGER, "value2" BOOL);
INSERT INTO "test_update" ("name", "value", "value2") VALUES ('name 1', 22, true), ('name 2', 33, false);
CREATE TABLE "test_insert_multiple" ("id" SERIAL, "name" VARCHAR (256), "value" INTEGER, "value2" BOOL);
CREATE TABLE "test_select_multiple" ("id" SERIAL, "name" VARCHAR (256), "value" INTEGER, "value2" BOOL);
INSERT INTO "test_select_multiple" ("name", "value", "value2") VALUES ('name 1', 22, false), ('name 2', 33, true), ('name 3', 44, true);
CREATE TABLE "test_select_one" ("id" SERIAL, "name" VARCHAR (256), "value" INTEGER, "value2" BOOL);
INSERT INTO "test_select_one" ("name", "value", "value2") VALUES ('name 1', 22, false), ('name 2', 33, true), ('name 1', 22, false);
CREATE TABLE "test_query_builder" ("id" SERIAL, "name" VARCHAR (256), "value" INTEGER, "value2" BOOL);
INSERT INTO "test_query_builder" ("name", "value", "value2") VALUES ('name 1', 22, false), ('name 2', 33, true);
CREATE TABLE "test_table_select_view" ("id" SERIAL PRIMARY KEY);
